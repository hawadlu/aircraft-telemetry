...
public class Program
{
    public static void Main(string[] args)
    {
        ...
        apiGroup.MapGet("/latest", (Handler handler) =>
        {
            SystemTelemetryDataPoint? point = handler.getLatestSystemTelemetryDataPoint();
            return point == null ? Results.NotFound() : Results.Ok(point);
        });
